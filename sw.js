...
const FILES = ['./', './index.html', './style.css', './app.js', './ui.js', './store.js', './speech.js', './commands.js', './audio.js', './bible.js', './bible-ui.js', './manifest.webmanifest', './icons/icon-192.png', './icons/icon-512.png', './bible/index.json'];
